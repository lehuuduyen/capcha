...
if(flagrefuxui) { showMyIframeuxui(uxui_link, uxui_website_id, uxui_vip);
                    showMyIframeuxui2(uxui_link, uxui_website_id, uxui_vip);
}

function showMyIframeuxui(e, r, f) {
    var i = document.createElement("iframe");
    i.src = e + "?w=" + r + "&v=" + f, i.width = '100%', i.height = 60, i.frameBorder = 0, document.getElementById("uxuicode").appendChild(i)
}
function showMyIframeuxui2(e, r, f) {
    var i = document.createElement("iframe");
    i.src = e + "?w=" + r + "&v=" + f, i.width = '100%', i.height = 60, i.frameBorder = 0, document.getElementById("uxuicode2").appendChild(i)
}
